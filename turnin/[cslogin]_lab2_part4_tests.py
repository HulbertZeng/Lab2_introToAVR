...
tests = [ {'description': 'First Test',
    ...
    'steps': [ {'inputs': [('PINA',0x2F), ('PINB',0x2F), ('PINC',0x2E)], 'iterations': 5 } ],
    'expected': [('PORTD',0x8C)],
    },
    ...
    'steps': [ {'inputs': [('PINA',0x82), ('PINB',0x02), ('PINC',0x02)], 'iterations': 5 } ],
    'expected': [('PORTD',0x86)],
    },
    {'description': 'Fifth Test',
    'steps': [ {'inputs': [('PINA',0x16), ('PINB',0xFF), ('PINC',0xFF)], 'iterations': 5 } ],
    'expected': [('PORTD',0x87)],
    },
